...
if arguments["--choose-matrix"] is None:
    ...
    m_1.loadMatrix("38factors 512runs resolution4")
    m_2.loadMatrix("38factors 512runs resolution4")
    m2.loadMatrix("38factors 512runs resolution4")
else:
    m = fracfact.FactorialMatrix(len(flags))
