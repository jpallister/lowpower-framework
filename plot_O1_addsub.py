...
print len(rx), len(ry), len(ryt), len(rx_pos)

fig = figure(figsize=(15,8))
ax1 = fig.add_subplot(111)

# plot energies
rects1 = ax1.bar(rx_pos, ry, align='center', width=0.4, color='#006600')
# plot times
rects2 = ax1.bar(map(lambda x: x + 0.4, rx_pos), ryt, align='center', width=0.4, color='c', hatch="/")
